...
namespace OnlineMarket.Web.Migrations
{
    ...
    [Migration("20180518085943_initialDalEntities")]
    partial class initialDalEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineMarket.DataAccess.Entities.CurrentRateDataModel", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("CurrentRateDataModel");
                });
            ...
            modelBuilder.Entity("OnlineMarket.DataAccess.Entities.ExchangeRatesDataModel", b =>
                {
                    b.HasBaseType("OnlineMarket.DataAccess.Entities.CurrentRateDataModel");

                    b.Property<DateTime>("СhangeDate");

                    b.ToTable("ExchangeRates");

                    b.HasDiscriminator().HasValue("ExchangeRatesDataModel");
                });
